...
extension ViewController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        let size = self.playerCollect.frame.size
...
//    }
    ...
    private func findCurrentPath() -> IndexPath? {
        ...
        visibleRect.origin = playerCollect.contentOffset
        visibleRect.size = playerCollect.bounds.size

        let visiblePoint = CGPoint(x: visibleRect.midX, y: visibleRect.midY)

//        guard let indexPath = sliderCollectionView.indexPathForItem(at: visiblePoint) else { return }
        return playerCollect.indexPathForItem(at: visiblePoint)
//        let p = CGPoint(x: playerCollect.frame.width, y: playerCollect.contentOffset.y + playerCollect.frame.width)
